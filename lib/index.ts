...
export class Plugin {
    ...
    #loadDefaultTextColors() {
        ...
        text.createVariable('text-secondary_on-brand', colors['brand'][200], colors['brand'][300])
        ...
        text.createVariable('text-tertiary_on-brand', colors['brand'][200], colors['gray-dark'][400])
        ...
        text.createVariable('text-quaternary_on-brand', colors['brand'][300], colors['gray-dark'][400])
        ...
        text.createVariable('text-brand-secondary', colors['brand'][700], colors['gray-dark'][300])
        text.createVariable('text-brand-tertiary', colors['brand'][600], colors['gray-dark'][400])
        text.createVariable('text-brand-tertiary_alt', colors['brand'][600], colors['gray-dark'][50])
